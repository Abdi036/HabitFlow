    ...
    <LinearGradient colors={colors.background} className="flex-1">
      ...
      <View className="px-6 pt-8 pb-6 mt-10">
        <View className="flex-row justify-between items-center mb-6">
          <View>
            <Text className={`${colors.text} text-4xl font-bold`}>
              Today&apos;s Habits
            </Text>
        ...
        <View className={`${colors.card} p-6 rounded-3xl`}>
          <View className="flex-row justify-between items-center">
            <View>
              <Text
                className={`${colors.textSecondary} text-sm font-medium mb-2`}
              >
                Daily Progress
              </Text>
            ...
            <View
              className={`w-24 h-24 rounded-full ${isDark ? "bg-white/10" : "bg-gray-100"} items-center justify-center`}
            >
      ...
      <View className="flex-1 px-6">
        <Text className={`${colors.text} font-semibold text-lg mb-4`}>
          Your Habits
        </Text>
